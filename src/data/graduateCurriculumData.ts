...
export const graduateCurricula: GraduateCurriculum[] = [
  ...
  // =========================================================================
  {
    ...
    responsibleLecturers: [
      {
        name: "พระธรรมวชิราจารย์, รศ.ดร. (สุชาติ กิตฺติปญฺโญ)",
        academicTitle: "รองศาสตราจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ศศ.ม. (ภาษาสันสกฤต)", "พธ.บ. (ปรัชญา)", "ป.ธ.๘"],
        position: "อาจารย์ผู้รับผิดชอบหลักสูตร",
        specialization: "พระพุทธศาสนา, วิปัสสนาภาวนา, ภาษาบาลี-สันสกฤต"
      },
      {
        name: "รศ.ดร.เวทย์ บรรณกรกุล",
        academicTitle: "รองศาสตราจารย์, ดร.",
        degrees: ["พธ.ด. (บาลีพุทธศาสตร์)", "ศษ.ม. (ประชากรศึกษา)", "พธ.บ. (ปรัชญา)", "ป.ธ.๙"],
        position: "อาจารย์ผู้รับผิดชอบหลักสูตร",
        specialization: "พระพุทธศาสนา, บาลีพุทธศาสตร์, วิปัสสนาภาวนา, ไวยากรณ์บาลี"
      },
      {
        name: "ผศ.ดร.สุพิชฌาย์ พรพิชณรงค์",
        academicTitle: "ผู้ช่วยศาสตราจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ศน.ม. (พุทธศาสน์ศึกษา)", "บธ.ม. (บริหารธุรกิจ)", "ศศ.บ. (ภาษาไทย)"],
        position: "อาจารย์ผู้รับผิดชอบหลักสูตร",
        specialization: "พระพุทธศาสนา, วิจัยการศึกษาพุทธศาสตร์, ศาสนาและเทววิทยา"
      },
      {
        name: "พระมหาเสฏฐวุฒิ วชิรญาโณ, ดร. (ปาสวน)",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "พธ.ม. (พระพุทธศาสนา)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "พระไตรปิฎกเถรวาท, นวังคสัตถุศาสน์, อรรถกถาฎีกา"
      },
      {
        name: "ดร.ธนสิทธิ์ ฉัตรสุวรรณ",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ศศ.ม. (พุทธศาสนศึกษา)", "พธ.บ. (ภาษาอังกฤษ)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "พระพุทธศาสนา, พุทธศาสนศึกษา, ภราดรภาพพหุวัฒนธรรม, ภาษาบาลี",
        cvUrl: "/faculty/CV-Dr-Thanasit-Chatsuwan.pdf",
        contact: "097-0923164 (t-502@hotmail.com)"
      },
      {
        name: "พระมหาทรงชัย วิชยเภรี (ศิริ), ดร.",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ค.ด. (การสอนภาษาไทย)", "พธ.ม. (พระพุทธศาสนา)", "ป.อบ.", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "การใช้ภาษาบาลีชั้นสูง, ภาษาบาลีระดับดุษฎีบัณฑิต, การสอนภาษาไทย",
        cvUrl: "/faculty/CV-Dr-Phramaha-Songchai-Vijayabheri.pdf"
      },
      {
        name: "ดร.สมบูรณ์ จารุณะ",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระไตรปิฎกศึกษา)", "ศศ.ม. (การสอนสังคมศึกษา)", "พธ.บ. (บาลีพุทธศาสตร์)"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "พระไตรปิฎกศึกษา, รูปแบบการศึกษาคัมภีร์อภิธัมมาวตาร, บาลีพุทธศาสตร์",
        cvUrl: "/faculty/CV-Dr-Somboon-Jaruna.docx"
      },
      {
        name: "พระมหาศุภวัฒน์ ฐานวุฑฺโฒ (บุญทอง), ดร.",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "พธ.ม. (พระพุทธศาสนา)", "บธ.ม.", "วท.บ. (วิทยาการคอมพิวเตอร์)", "ป.ธ.๖", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "พระพุทธศาสนา, เทคโนโลยีดิจิทัลและพุทธปัญญาประดิษฐ์, จิตวิทยาในพระไตรปิฎก",
        cvUrl: "/faculty/CV-Dr-Phramaha-Suphawat-Boonthong.docx"
      }
    ],
    courses: [
      {
  ...
  // =========================================================================
  {
    ...
    responsibleLecturers: [
      ...
      },
      {
        ...
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "พธ.ม. (พระพุทธศาสนา)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "สัมมนาพระไตรปิฎก, นวังคสัตถุศาสน์, ธรรมปฏิบัติชั้นสูง"
      },
      {
        name: "ดร.ธนสิทธิ์ ฉัตรสุวรรณ",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ศศ.ม. (พุทธศาสนศึกษา)", "พธ.บ. (ภาษาอังกฤษ)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "สัมมนาพระไตรปิฎกเถรวาท, การใช้ภาษาบาลี ๒, พุทธศาสนศึกษา",
        cvUrl: "/faculty/CV-Dr-Thanasit-Chatsuwan.pdf",
        contact: "097-0923164 (t-502@hotmail.com)"
      },
      {
        ...
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ค.ด. (การสอนภาษาไทย)", "พธ.ม. (พระพุทธศาสนา)", "ป.อบ.", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "ภาษาบาลีเบื้องต้น, การใช้ภาษาบาลี ๒, ไวยากรณ์บาลี",
        cvUrl: "/faculty/CV-Dr-Phramaha-Songchai-Vijayabheri.pdf"
      },
      {
        name: "ดร.สมบูรณ์ จารุณะ",
  ...
  // =========================================================================
  {
    ...
    responsibleLecturers: [
      ...
      },
      {
        ...
        position: "อาจารย์ผู้รับผิดชอบหลักสูตร",
        specialization: "พระอภิธรรมปิฎก, จิต เจตสิก รูป นิพพาน, ปรมัตถธรรม"
      },
      {
        name: "พระมหาทรงชัย วิชยเภรี (ศิริ), ดร.",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ค.ด. (การสอนภาษาไทย)", "พธ.ม. (พระพุทธศาสนา)", "ป.อบ. (อภิธรรมบัณฑิต)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "พระอภิธรรม, อภิธรรมบัณฑิต, ไวยากรณ์บาลี",
        cvUrl: "/faculty/CV-Dr-Phramaha-Songchai-Vijayabheri.pdf"
      },
      {
        name: "พระมหาเสฏฐวุฒิ วชิรญาโณ, ดร. (ปาสวน)",
        ...
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "พธ.ม. (พระพุทธศาสนา)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "การศึกษาวิเคราะห์ปัฏฐาน, ธรรมปฏิบัติชั้นสูง, พระไตรปิฎก"
      },
      {
        name: "ดร.ธนสิทธิ์ ฉัตรสุวรรณ",
        academicTitle: "อาจารย์, ดร.",
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "ศศ.ม. (พุทธศาสนศึกษา)", "พธ.บ. (ภาษาอังกฤษ)", "ป.ธ.๙", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "สัมมนาพระไตรปิฎก, การใช้ภาษาบาลี, พุทธศาสนศึกษา",
        cvUrl: "/faculty/CV-Dr-Thanasit-Chatsuwan.pdf",
        contact: "097-0923164 (t-502@hotmail.com)"
      },
      {
      ...
      },
      {
        ...
        degrees: ["พธ.ด. (พระพุทธศาสนา)", "พธ.ม. (พระพุทธศาสนา)", "บธ.ม.", "วท.บ. (วิทยาการคอมพิวเตอร์)", "ป.ธ.๖", "น.ธ.เอก"],
        position: "อาจารย์ผู้สอนประจำหลักสูตร (วส. มจร)",
        specialization: "พระอภิธรรมปิฎก, เทคโนโลยีดิจิทัลและพุทธปัญญาประดิษฐ์, จิตวิทยาในพระไตรปิฎก",
        cvUrl: "/faculty/CV-Dr-Phramaha-Suphawat-Boonthong.docx"
      }
    ],
    courses: [
