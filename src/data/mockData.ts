import { officialNovicesList, officialMonksList, SanghaMonk, SanghaNovice } from "./sanghaData";
...
export const mockSamaneras: Samanera[] = officialNovicesList.map((n, idx) => ({
  id: n.id,
  enrollmentNo: `สณ.๖๗${String(n.orderNo).padStart(3, '0')}`,
  mcuId: `670150${String(n.orderNo).padStart(4, '0')}`,
  fullName: n.fullName,
  paliName: n.name.replace("สามเณร", "").trim(),
  age: n.age,
  vassa: Math.max(1, Math.min(6, n.age - 7)),
  originTemple: n.originTemple,
  kuti: n.kuti,
  paliLevel: n.paliLevel,
  bloodType: ["O", "A", "B", "AB"][idx % 4],
  allergies: idx % 10 === 0 ? "แพ้อาหารทะเล" : (idx % 14 === 0 ? "แพ้ถั่วลิสง" : "ไม่มีประวัติแพ้ยาหรืออาหาร"),
  healthStatus: n.healthStatus,
  todayRoutine: n.todayRoutine,
  mukhopathaScore: n.mukhopathaScore,
  patronName: n.country !== "ไทย" ? `มูลนิธิพุทธศาสน์นานาชาติอุปถัมภ์ (${n.country})` : "โยมอุปถัมภ์วัดบาลีเถรวาทสังฆาราม",
}));
...
export const mockSystemUsers: SystemUser[] = [
  ...
  // บัญชีพระภิกษุสงฆ์ที่มีอยู่จริง วัดบาลีเถรวาทสังฆาราม (๒๐ รูป)
  {
    id: "usr-monk-01",
    username: "monk.01",
    fullName: "พระราชวชิรเวที ขนฺติโก (บุญรัตนะ)",
    title: "พระราชวชิรเวที",
    paliName: "ขนฺติโก",
    sanghaRank: "พระเถระประจำสถาบัน",
    vassa: 50,
    originTemple: "วัดบาลีเถรวาทสังฆาราม",
    department: "สภาวิทยาลัย (พระมหาเถระที่ปรึกษา)",
    role: "SUPER_ADMIN",
    monasticStatus: "ACTIVE_MONK",
    accountStatus: "ACTIVE",
    email: "monk01@mvu.mcu.ac.th",
    phone: "089-000-0001",
    lineConnected: true,
  ...
  },
  {
    ...
    vassa: 48,
    originTemple: "วัดบาลีเถรวาทสังฆาราม",
    department: "คณะผู้บริหารและที่ปรึกษาสงฆ์",
    role: "EXECUTIVE_BOARD",
    monasticStatus: "ACTIVE_MONK",
    accountStatus: "ACTIVE",
    email: "monk02@mvu.mcu.ac.th",
    phone: "089-000-0002",
    lineConnected: true,
    lastLogin: "2026-09-08 09:30",
    permissions: {
  ...
  },
  {
    ...
    title: "พระครูสังฆรักษ์อำนวย",
    paliName: "เขมปญฺโญ",
    sanghaRank: "พระเถระประจำสถาบัน",
    vassa: 32,
    originTemple: "วัดบาลีเถรวาทสังฆาราม",
    department: "สำนักวิชาการ / คณาจารย์สงฆ์",
    role: "PALI_TEACHER",
    monasticStatus: "ACTIVE_MONK",
    accountStatus: "ACTIVE",
    email: "monk04@mvu.mcu.ac.th",
    phone: "089-000-0004",
    lineConnected: true,
    lastLogin: "2026-09-08 09:30",
    permissions: {
  ...
  },
  {
    ...
    title: "พระมหาณรงค์ฤทธิ์",
    paliName: "กิตฺติโสภโณ",
    sanghaRank: "พระเถระประจำสถาบัน",
    vassa: 18,
    originTemple: "วัดบาลีเถรวาทสังฆาราม",
    department: "สำนักวิชาการ / คณาจารย์สงฆ์",
  ...
  },
  {
    ...
    title: "พระปลัดชัยฤทธิ์",
    paliName: "โชติวโร",
    sanghaRank: "พระเถระประจำสถาบัน",
    vassa: 15,
    originTemple: "วัดบาลีเถรวาทสังฆาราม",
    department: "สำนักงานวิทยาลัย (สารบรรณสงฆ์)",
    role: "REGISTRAR_STAFF",
    monasticStatus: "ACTIVE_MONK",
    accountStatus: "ACTIVE",
    email: "monk10@mvu.mcu.ac.th",
    phone: "089-000-0010",
    lineConnected: true,
    lastLogin: "2026-09-08 09:30",
    permissions: {
...
export interface HRStaff {
  ...
  paliName?: string;
  sanghaRank?: string;
  type: "บรรพชิต (พระภิกษุ)" | "ฆราวาส (อาจารย์)" | "ฆราวาส (เจ้าหน้าที่)" | "พนักงานบริการทั่วไป" | "บรรพชิต (เจ้าหน้าที่)";
  position: string;
...
export const mockHRStaffList: HRStaff[] = [
  {
    ...
    position: 'อาจารย์/ผอ. /รศ.',
    positionNumber: '1421004',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (ประจำ)',
  ...
  },
  {
    ...
    position: 'อาจารย์/รอง ผอ./รศ.',
    positionNumber: '1421012',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'รองศาสตราจารย์ (รศ.ดร.)',
  ...
  {
    id: 'hr-03',
    name: 'พระมหาทรงชัย,ดร.',
    position: 'อาจารย์',
    positionNumber: '1421008',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
    status: 'ปฏิบัติหน้าที่ปกติ',
    teachingHoursPerWeek: 16,
    missionLeaveCount: 0,
  ...
  {
    id: 'hr-04',
    name: 'พระมหาวีรวิชญ์ สัตตารัมย์',
    position: 'อาจารย์',
    positionNumber: '1421018',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'พระคัมภีราจารย์ / พระอาจารย์',
    status: 'ปฏิบัติหน้าที่ปกติ',
    teachingHoursPerWeek: 16,
    missionLeaveCount: 0,
    evaluationScore: 96.5
  ...
  {
    id: 'hr-05',
    name: 'นายถนัด ไชยพันธ์',
    position: 'อาจารย์',
    positionNumber: '1421019',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'เจ้าหน้าที่ปฏิบัติการวิชาชีพ',
    status: 'ปฏิบัติหน้าที่ปกติ',
    teachingHoursPerWeek: 16,
    missionLeaveCount: 0,
    evaluationScore: 96.5
  ...
  {
    id: 'hr-06',
    name: 'พระมหาศุภวัฒน์,ดร.',
    position: 'อาจารย์',
    positionNumber: '1421020',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
  ...
  {
    id: 'hr-07',
    name: 'ดร.สมบูรณ์ จารุณะ',
    position: 'อาจารย์/ผอ.',
    positionNumber: '1421021',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
  ...
  {
    id: 'hr-08',
    name: 'ดร.ธนสิทธิ์ ฉัตรสุวรรณ',
    position: 'อาจารย์',
    positionNumber: '1421022',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
  ...
  {
    id: 'hr-09',
    name: 'พระมหาเสฏฐวุฒิ,ดร.',
    position: 'อาจารย์/ผอ.',
    positionNumber: '1421023',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (ประจำ)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
  ...
  },
  {
    ...
    position: 'อาจารย์/รอง ผอ./ผศ.',
    positionNumber: '1427005',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (อัตราจ้าง)',
    department: 'สำนักวิชาการ',
  ...
  {
    id: 'hr-11',
    name: 'ดร.ประชา แสงทองสุข',
    position: 'อาจารย์',
    positionNumber: '1427001',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (อัตราจ้าง)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
  ...
  {
    id: 'hr-12',
    name: 'ดร.บุญชู พรพรหมพิพัฒน์',
    position: 'อาจารย์',
    positionNumber: '1427002',
    type: 'ฆราวาส (อาจารย์)',
    group: 'สายวิชาการ (อัตราจ้าง)',
    department: 'สำนักวิชาการ',
    academicRank: 'อาจารย์ (ดร.)',
  ...
  {
    id: 'hr-13',
    name: 'พระมหาชณัตนิติสนธ์ คุณสํวโร',
    paliName: 'คุณสํวโร',
    position: 'อาจารย์',
    positionNumber: '1427004',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (อัตราจ้าง)',
    department: 'สำนักวิชาการ',
    academicRank: 'พระคัมภีราจารย์ / พระอาจารย์',
  ...
  {
    id: 'hr-14',
    name: 'พระมหาณัฐวุฒิ ถิรธมโม',
    paliName: 'ถิรธมฺโม',
    position: 'อาจารย์',
    positionNumber: '1427006',
    type: 'บรรพชิต (พระภิกษุ)',
    group: 'สายวิชาการ (อัตราจ้าง)',
    department: 'สำนักวิชาการ',
    academicRank: 'พระคัมภีราจารย์ / พระอาจารย์',
  ...
  {
    id: 'hr-15',
    name: 'นส.จันจิรา เอี่ยมใจดี',
    position: 'นักจัดการงานทั่วไป',
    positionNumber: '5612001',
    type: 'ฆราวาส (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
  ...
  {
    id: 'hr-16',
    name: 'น.ส. วรัญญู ศรีวงศ์',
    position: 'นักวิชาการการศึกษา',
    positionNumber: '5622001',
    type: 'ฆราวาส (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'สำนักงานวิทยาลัย',
    academicRank: 'เจ้าหน้าที่ปฏิบัติการวิชาชีพ',
  ...
  {
    id: 'hr-17',
    name: 'น.ส. ศิริภรณ์ สุริโย',
    position: 'นักวิชาการการเงินและบัญชี',
    positionNumber: '5612002',
    type: 'ฆราวาส (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'สำนักงานวิทยาลัย',
    academicRank: 'เจ้าหน้าที่ปฏิบัติการวิชาชีพ',
  ...
  {
    id: 'hr-18',
    name: 'น.ส.สิริลักษณ์ ก้องสุรกาญจน์',
    position: 'นักวิชาการการเงินและบัญชี',
    positionNumber: '5418002',
    type: 'ฆราวาส (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'สำนักงานวิทยาลัย',
    academicRank: 'เจ้าหน้าที่ปฏิบัติการวิชาชีพ',
  ...
  {
    id: 'hr-19',
    name: 'นายสุเทพ ประยูรหอม',
    position: 'นักวิเคราะห์นโยบายและแผน',
    positionNumber: '5418003',
    type: 'ฆราวาส (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'สำนักงานวิทยาลัย',
    academicRank: 'เจ้าหน้าที่ปฏิบัติการวิชาชีพ',
  ...
  {
    id: 'hr-20',
    name: 'นายไพสิน ป้องภา',
    position: 'นักจัดการงานทั่วไป',
    positionNumber: '5418004',
    type: 'ฆราวาส (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'สำนักงานวิทยาลัย',
    academicRank: 'เจ้าหน้าที่ปฏิบัติการวิชาชีพ',
  ...
  {
    id: 'hr-21',
    name: 'พระมหาณรงค์ฤทธิ์ ธมมโสภโณ',
    paliName: 'ธมฺมโสภโณ',
    position: 'นักวิชาการศึกษา',
    positionNumber: '-',
    type: 'บรรพชิต (เจ้าหน้าที่)',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'สำนักงานวิทยาลัย',
    academicRank: 'พระคัมภีราจารย์ / พระอาจารย์',
    status: 'ปฏิบัติหน้าที่ปกติ',
  ...
  {
    id: 'hr-25',
    name: 'นายปิยพัทธ์ แก้วมา',
    position: 'แม่บ้าน',
    positionNumber: '-',
    type: 'พนักงานบริการทั่วไป',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'หน่วยอาคารสถานที่และยานพาหนะ',
    academicRank: 'แม่บ้าน',
    status: 'ปฏิบัติหน้าที่ปกติ',
    teachingHoursPerWeek: 0,
    missionLeaveCount: 0,
    evaluationScore: 95.0
  ...
  {
    id: 'hr-32',
    name: 'น.ส.วรรณธนันท์ ขุนพิทักษ์',
    position: 'แม่บ้าน',
    positionNumber: '-',
    type: 'พนักงานบริการทั่วไป',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
  ...
  {
    id: 'hr-33',
    name: 'นายสมควร แสงทอง',
    position: 'พนักงานขับรถ',
    positionNumber: '-',
    type: 'พนักงานบริการทั่วไป',
    group: 'สายปฏิบัติการและบริการ (อัตราจ้าง)',
    department: 'หน่วยอาคารสถานที่และยานพาหนะ',
    academicRank: 'พนักงานขับรถ',
    status: 'ปฏิบัติหน้าที่ปกติ',
    teachingHoursPerWeek: 0,
    missionLeaveCount: 0,
    evaluationScore: 95.0
...
export { officialMonksList, officialNovicesList };
